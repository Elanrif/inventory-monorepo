        ...
        <div className="absolute inset-0">
          <div className="absolute bottom-0 flex flex-col items-center justify-center text-white p-8">
            ...
            <p className="">
              ...
              <br />
              Director of Digital Marketing Technologie
            </p>
          </div>
          <div className="absolute top-5 left-10 m-4 flex items-center gap-2">
            <p>
              <FaBowlingBall className="text-white text-2xl" />
            </p>
      ...
      <div className="w-2/3  flex flex-col gap-5 items-center justify-center mt-10">
        <div className="flex flex-col items-center justify-start ">
          ...
          <p className="text-slate-600 text-center">
            Build your design system effortlessly with our <br /> powerful
            components library.
          </p>
        </div>
        <div className="w-[355px]">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
              ...
              <a
                href="#"
                className="text-md text-blue-500 hover:underline font-bold"
              >
                Mot de passe oublié ?
              </a>
              ...
              <Button
                type="submit"
                className="rounded-3xl w-[355px] text-white bg-blue-500 hover:bg-blue-600 mt-3"
              >
                Se connecter
              </Button>
            </form>
        ...
        <Button
          type="submit"
          className="rounded-3xl w-[355px] bg-gray-300 text-black relative flex items-center justify-center pl-10 "
        >
          <FcGoogle className=" absolute left-4 size-7" />
